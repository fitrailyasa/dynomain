<x-admin-table>
    ...
    <x-slot name="search">
        ...
        @endcan
        @can('edit:domain')
            <button type="button" class="btn btn-sm btn-success ms-2" id="bulkStatusOnBtn" style="display:none" onclick="bulkStatusConfirm('domain', 1)">
                <i class="fas fa-check-circle"></i> Aktifkan
            </button>
            <button type="button" class="btn btn-sm btn-warning ms-2" id="bulkStatusOffBtn" style="display:none" onclick="bulkStatusConfirm('domain', 0)">
